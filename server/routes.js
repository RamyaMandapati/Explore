...
const {
  ...
  getMessages,
  messageMarkAsRead,
} = require("./modules/messageModule");

const {
  getMessageNotification,
} = require("./modules/messageNotificationModule");
...
router.post("/users/interestedActivity", interestedActivity);
...
router.put("/messages/markAsRead", messageMarkAsRead);

// message Notifications
router.get("/messages/notifications/:userId", getMessageNotification);
